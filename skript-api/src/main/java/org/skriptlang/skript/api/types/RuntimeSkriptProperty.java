 ...
 * This is stored under the value's {@link RuntimeSkriptType}.
 * @param <TReceiver> The receiver - the type of the value that owns this property,
 *                    which should be the same as the type of the {@link RuntimeSkriptType}.
 * @param <TValue> The type of the value of the property.
 */
public interface RuntimeSkriptProperty<TReceiver extends SkriptValue, TValue extends SkriptValue> {
	 ...
	 */
	RuntimeSkriptType<TValue> valueType();
