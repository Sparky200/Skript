...
/**
 * A type property that is staged to be constructed into a {@link RuntimeSkriptProperty} with a {@link SkriptRuntime}.
...
public interface SkriptProperty<TReceiver extends SkriptValue, TValue extends SkriptValue> {
	 ...
	 */
	RuntimeSkriptProperty<TReceiver, TValue> construct(SkriptRuntime runtime);
